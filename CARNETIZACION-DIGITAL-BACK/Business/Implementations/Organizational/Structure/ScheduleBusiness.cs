...
{
    public class ScheduleBusiness : BaseBusiness<Schedule, ScheduleDtoRequest, ScheduleDto>, IScheduleBusiness
    {
        public ScheduleBusiness(ICrudBase<Schedule> data, ILogger<Schedule> logger, IMapper mapper) : base(data, logger, mapper)
        {
        }
