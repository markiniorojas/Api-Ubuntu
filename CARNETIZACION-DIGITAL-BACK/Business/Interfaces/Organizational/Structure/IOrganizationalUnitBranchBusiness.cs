...
{
    public interface IOrganizationalUnitBranchBusiness : IBaseBusiness<OrganizationalUnitBranch, OrganizationalUnitBranchDtoRequest, OrganizationalUnitBranchDto>
    {
    }
}
